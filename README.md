**IMPORTANT the One Time Passwork (OTP) does not work on ESTU-Guest as it has a email spam filter that will NOT allow Emails to be sent SMTP. It should work (as of Nov 2023) on the regular "ETSU" Wifi
